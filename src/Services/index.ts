...
export const forgotPassword = (data:object)=>postCall(`/auth/forgot-password-sendOtp`,data);
    export const otpVerification =(email:string,otp:string)=> postCall(`/auth/verify-otp`,{email,otp});
