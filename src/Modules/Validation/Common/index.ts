...
export const JoiRequiredRandomId = (Entity?: string) =>
    JoiRandomId(Entity).required();
...
export const JoiRequiredName = (
    Entity?: string,
    option?: NameValidationOption
) => JoiName(Entity, (option = {})).required();

export const JoiRegularName = (
    Entity?: string,
    option?: NameValidationOption
) =>
    JoiName(Entity, {
...
export const JoiRequiredRegularName = (
    Entity?: string,
    option?: NameValidationOption
) => JoiRegularName(Entity, (option = {})).required();
...
export const JoiRequiredPassword = (
    ...
    min?: number,
    max?: number
) => JoiPassword(Entity, min, max).required();
...
export const JoiRequiredPhone = (Entity?: string) =>
...
export const JoiRequiredEmail = (Entity?: string) =>
    JoiEmail(Entity).required();
